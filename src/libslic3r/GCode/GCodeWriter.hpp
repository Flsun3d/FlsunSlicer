...
public:
    ...
    std::string set_print_acceleration(unsigned int acceleration, unsigned int deceleration)
    {
        return set_acceleration_internal(Acceleration::Print, acceleration, deceleration);
    }
    ...
    std::string set_travel_acceleration(unsigned int acceleration, unsigned int deceleration)
    {
        return set_acceleration_internal(Acceleration::Travel, acceleration, deceleration);
    }
    ...
    std::string travel_to_xy(const double &travelsped, const Vec2d &point, const std::string &comment = std::string());
    std::string _travel_to_z(double travel, double z, const std::string &comment);
    ...
    std::string travel_to_xyz(const Vec3d &from, const Vec3d &to, const std::string_view comment = {}, int new_layer = 1);
    std::string get_travel_to_z_gcode(double z, const std::string_view comment) const;

    std::string spiral_travel_to_z(const Vec3d& from, const Vec3d& to,double , const std::string &comment);
    std::string _spiral_travel_to_z(const Vec3d &from, const Vec3d &to, double z, const std::string &comment);
...
private:
    ...
    std::string set_acceleration_internal(Acceleration type, unsigned int acceleration, unsigned int deceleration);
};
