   ...
   /* if (! boost::filesystem::exists(path)) {
    ...
    for (auto &section : tree) {
        if (boost::starts_with(section.first, printer_model_key)) {
            ...
            if (model.family.empty() && res.name == "Flsun Research") {
...
static std::vector<std::string> s_Preset_print_options {
    ...
    "solid_infill_below_area", "only_retract_when_crossing_perimeters", "infill_first","top_level_single_layer_wall",
    "ironing", "ironing_type", "ironing_flowrate", "ironing_speed", "ironing_spacing",
    "max_print_speed", "max_volumetric_speed", "avoid_crossing_perimeters_max_detour",
    "fuzzy_skin", "fuzzy_skin_thickness", "fuzzy_skin_point_dist",
    "max_volumetric_extrusion_rate_slope_positive", "max_volumetric_extrusion_rate_slope_negative",
    "perimeter_speed", "small_perimeter_speed", "external_perimeter_speed", "infill_speed","switch_layer_infill_speed","solid_infill_speed",
                                                       "enable_dynamic_overhang_speeds",
                                                       "enable_inner_dynamic_overhang_speeds",
                                                       "overhang_speed_0",
                                                       "overhang_speed_1",
                                                       "overhang_speed_2",
                                                       "overhang_speed_3",
    "top_solid_infill_speed", "support_material_speed", "support_material_xy_spacing", "support_material_interface_speed",
                                                       "bridge_speed",
                                                       "small_boundary_radius",
                                                       "gap_fill_speed",
                                                       "gap_fill_enabled",
                                                       "perimeters_corner_velocity",
                                                       "external_perimeters_corner_velocity",
                                                       "solid_infill_corner_velocity",
                                                       "top_solid_infill_corner_velocity",
                                                       "infill_corner_velocity",
                                                       "bridge_corner_velocity",
                                                       "travel_speed",
                                                       "travel_speed_first_layer",
                                                       "travel_speed_z",
                                                       "first_layer_speed",
                                                       "first_wall_velocity",
                                                       ...
                                                       "external_perimeter_deceleration",
                                                       "top_solid_infill_deceleration",
                                                       "solid_infill_deceleration",
                                                       "travel_deceleration",
                                                       "infill_deceleration",
                                                       "bridge_deceleration",
                                                       "first_layer_deceleration",
                                                       "first_layer_deceleration_over_raft",
                                                       "perimeter_deceleration",
...
static std::vector<std::string> s_Preset_filament_options {
    ...
    "extrusion_multiplier", "inner_wall_flow", "external_wall_flow", "fill_flow", "top_flow", "bottom_solid_fill_flow", "first_flow",
    "filament_density",
    "filament_cost",
    ...
    // Retract overrides
    "filament_retract_length", "filament_retract_lift", "filament_estimated_empty_distance", "filament_retract_lift_above",
    "filament_retract_lift_below", "filament_retract_speed", "filament_deretract_speed", "filament_retract_restart_extra",
...
static std::vector<std::string> s_Preset_printer_options {
    "printer_technology", "autoemit_temperature_commands", "bed_shape", "bed_custom_texture", "bed_custom_model", "binary_gcode",
    "z_offset", "hot_bed_zoning", "gcode_flavor", "use_relative_e_distances",
    "use_firmware_retraction", "use_volumetric_e", "variable_layer_height",
    //FIXME the print host keys are left here just for conversion from the Printer preset to Physical Printer preset.
    "host_type", "print_host", "printhost_apikey", "printhost_cafile",
    "single_extruder_multi_material", "start_gcode", "end_gcode", "before_layer_gcode", "layer_gcode", "toolchange_gcode", "color_change_gcode", "pause_print_gcode", "template_custom_gcode",
...
static std::vector<std::string> s_Preset_sla_material_options {
    ...
    "compatible_prints", "compatible_prints_condition", "compatible_printers",
                                                              ...
                                                              "material_ow_support_head_penetration", "material_ow_support_head_width",
                                                              ...
                                                              "material_ow_relative_correction_x", "material_ow_relative_correction_y",
                                                              "material_ow_relative_correction_z", "material_ow_elefant_foot_compensation"};
...
{
    std::string name = Preset::remove_suffix_modified(name_w_suffix.empty() ? "Generic PLA_S1 @FLSUN" : name_w_suffix);
    // 1) Try to find the preset by its name.
