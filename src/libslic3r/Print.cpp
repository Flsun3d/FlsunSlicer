...
bool Print::invalidate_state_by_config_options(const ConfigOptionResolver & /* new_config */, const std::vector<t_config_option_key> &opt_keys)
{
    ...
    static std::unordered_set<std::string> steps_gcode = {
        ...
        "retract_lift", "estimated_empty_distance",
        "retract_lift_above",
        "retract_lift_below",
        ...
        "travel_acceleration","set_deceleration_acceleration",
    ...
    for (const t_config_option_key &opt_key : opt_keys) {
        if (steps_gcode.find(opt_key) != steps_gcode.end()) {
            ...
            || opt_key == "infill_first" ||
              opt_key == "top_level_single_layer_wall"
            ...
            || opt_key == "travel_speed" || opt_key == "travel_speed_first_layer"
            || opt_key == "travel_speed_z" || opt_key == "first_layer_speed" || opt_key == "first_wall_velocity"
            || opt_key == "z_offset" 
            || opt_key == "hot_bed_zoning") {
