...
class FillCorrugated : public Fill
{

public:
    FillCorrugated (){}
    Fill *clone() const override { return new FillCorrugated(*this); }
    ...
    // Correction applied to regular infill angle to maximize printing
    // speed in default configuration (degrees)
    static constexpr float CorrectionAngle1 = -45.;

    // Density adjustment to have a good %of weight.
    static constexpr double DensityAdjust1 = 2.44;

    // Gyroid upper resolution tolerance (mm^-2)
    static constexpr double PatternTolerance1 = 0.2;
