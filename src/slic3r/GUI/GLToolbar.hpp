...
wxDECLARE_EVENT(EVT_GLVIEWTOOLBAR_FULL, SimpleEvent);
wxDECLARE_EVENT(EVT_GLVIEWTOOLBAR_TOP, SimpleEvent);
wxDECLARE_EVENT(EVT_GLTOOLBAR_SEARCH, SimpleEvent);
wxDECLARE_EVENT(EVT_GLVIEWTOOLBAR_REAR, SimpleEvent);
wxDECLARE_EVENT(EVT_GLVIEWTOOLBAR_ISO, SimpleEvent);
wxDECLARE_EVENT(EVT_GLVIEWTOOLBAR_FRONT, SimpleEvent);
wxDECLARE_EVENT(EVT_GLVIEWTOOLBAR_LEFT, SimpleEvent);
wxDECLARE_EVENT(EVT_GLVIEWTOOLBAR_RIGHT, SimpleEvent);
