...
void show_info(wxWindow* parent, const wxString& message, const wxString& title)
{
    ...
    MessageDialog msg_wingow(parent, _L(message), wxString(SLIC3R_APP_NAME " - ") + (title.empty() ? _L("Notice") : _L(title)),
...
{
	return
		_L("Most likely the configuration was produced by a newer version of FlsunSlicer or by some FlsunSlicer fork.") + " " +
