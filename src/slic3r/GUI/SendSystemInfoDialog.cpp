...
// Following function saves current FlsunSlicer version into app config.
           ...
           wxDEFAULT_DIALOG_STYLE)
{
    ...
    wxString text2 = GUI::format_wxstr(
        _L("We do not send any personal information nor anything that would allow us "
           ...
           "installation are sent. FlsunSlicer is open source, if you want to "
    ...
    wxString html = GUI::format_wxstr(
            ...
            "<table><tr><td>"
            "<img src = \"" + resources_dir() + "/icons/FlsunSlicer_192px.png\" />"
            "</td><td align=\"left\">"
            + text0 + "<br / ><br / >"
            + text1 + "<br /><br />"
            "</td></tr></table>"
