...
const ImVec4 ImGuiWrapper::COL_GREY_DARK         = {0.8f, 0.8f, 0.8f, 1.0f};
const ImVec4 ImGuiWrapper::COL_GREY_LIGHT        = {0.5f, 0.5f, 0.5f, 1.0f};
const ImVec4 ImGuiWrapper::COL_GREEN_DARK        = {0.0f, 0.698f, 0.376f, 1.0f};
const ImVec4 ImGuiWrapper::COL_GREEN_LIGHT       = to_ImVec4(ColorRGBA::GREEN());
const ImVec4 ImGuiWrapper::COL_WINDOW_BACKGROUND = {0.941f, 0.941f, 0.940f, 1.0f};
const ImVec4 ImGuiWrapper::COL_BUTTON_BACKGROUND = COL_GREEN_DARK;
const ImVec4 ImGuiWrapper::COL_BUTTON_HOVERED    = COL_GREEN_LIGHT;
...
void ImGuiWrapper::draw(
    ...
    ImU32          color     /* = ImGui::GetColorU32(COL_GREEN_LIGHT)*/,
    float          thickness /* = 3.f*/)
{
...
void ImGuiWrapper::init_font(bool compress)
{
	...
	ImFont* font = io.Fonts->AddFontFromFileTTF((Slic3r::resources_dir() + "/fonts/" + (m_font_cjk ? "SourceHanSans-Normal.ttc" : "SourceHanSansCN-Normal.ttf")).c_str(), m_font_size, nullptr, ranges.Data);
    if (font == nullptr) {
    ...
    if (! m_font_cjk) {
		// Apple keyboard shortcuts are only contained in the CJK fonts.
        [[maybe_unused]]ImFont *font_cjk = io.Fonts->AddFontFromFileTTF((Slic3r::resources_dir() + "/fonts/SourceHanSans-Normal.ttc").c_str(), m_font_size, &config, ranges_keyboard_shortcuts);
...
void ImGuiWrapper::init_style()
{
    ...
    set_color(ImGuiCol_TitleBgActive, COL_GREEN_DARK);
    ...
    // Text selection
    set_color(ImGuiCol_TextSelectedBg, COL_GREEN_DARK);
    ...
    // Checkbox
    set_color(ImGuiCol_CheckMark, COL_GREEN_LIGHT);

    // ComboBox items
    set_color(ImGuiCol_Header, COL_GREEN_DARK);
    set_color(ImGuiCol_HeaderHovered, COL_GREEN_LIGHT);
    set_color(ImGuiCol_HeaderActive, COL_GREEN_LIGHT);

    // Slider
    set_color(ImGuiCol_SliderGrab, COL_GREEN_DARK);
    set_color(ImGuiCol_SliderGrabActive, COL_GREEN_LIGHT);

    // Separator
    set_color(ImGuiCol_Separator, COL_GREEN_LIGHT);

    // Tabs
    set_color(ImGuiCol_Tab, COL_GREEN_DARK);
    set_color(ImGuiCol_TabHovered, COL_GREEN_LIGHT);
    set_color(ImGuiCol_TabActive, COL_GREEN_LIGHT);
    set_color(ImGuiCol_TabUnfocused, COL_GREY_DARK);
    set_color(ImGuiCol_TabUnfocusedActive, COL_GREY_LIGHT);

    // Scrollbars
    set_color(ImGuiCol_ScrollbarGrab, COL_GREEN_DARK);
    set_color(ImGuiCol_ScrollbarGrabHovered, COL_GREEN_LIGHT);
    set_color(ImGuiCol_ScrollbarGrabActive, COL_GREEN_LIGHT);
}
