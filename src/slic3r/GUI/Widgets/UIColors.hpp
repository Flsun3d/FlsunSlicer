...
static const int clr_border_hovered  = 0x15a95d; // 0x00AE42;
...
static const int clr_background_focused         = 0x15a95d; // 0xEDFAF2;
static const int clr_background_disabled_dark   = 0x404040;//0xF0F0F0;
static const int clr_background_disabled_light  = 0xD9D9D9;//0xF0F0F0;下拉框选择颜色
