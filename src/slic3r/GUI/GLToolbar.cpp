...
wxDEFINE_EVENT(EVT_GLVIEWTOOLBAR_FULL, SimpleEvent);
wxDEFINE_EVENT(EVT_GLVIEWTOOLBAR_TOP, SimpleEvent);
wxDEFINE_EVENT(EVT_GLTOOLBAR_SEARCH, SimpleEvent);
wxDEFINE_EVENT(EVT_GLVIEWTOOLBAR_REAR, SimpleEvent);
wxDEFINE_EVENT(EVT_GLVIEWTOOLBAR_ISO, SimpleEvent);
wxDEFINE_EVENT(EVT_GLVIEWTOOLBAR_FRONT, SimpleEvent);
wxDEFINE_EVENT(EVT_GLVIEWTOOLBAR_LEFT, SimpleEvent);
wxDEFINE_EVENT(EVT_GLVIEWTOOLBAR_RIGHT, SimpleEvent);
